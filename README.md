...
> **AI 协作式 WebGIS 学习**：我定需求、选技术、验收，AI 写代码。
>
> 核心方法见 [docs/ai-collaboration.md](docs/ai-collaboration.md)
...
以上 5 个阶段的课程作为**能力演示样品**使用：想实现某个功能时翻一眼，确认"这能做"，然后按手册里的需求模板让 AI 实现。
